...
//var_dump( $result);
    if( mysqli_num_rows($result) > 0 )
    {
        ...
        // show error msg..
        echo ' <script> alert("You loged In");  </script> ';
...
<head>
    ...
    <title>AUIC LogIn</title>
</head>
<body>

<nav class="navbar navbar-expand-lg navbar-light navbar-laravel">
    <div class="container">
        <a class="navbar-brand" href="http://www.abasynisb.edu.pk/">AUIC Admissions</a>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form  method="post">
                            ...
                            <div class="col-md-6 offset-md-4">
                                <button class = "btn btn-lg btn-primary btn-block" onclick="" type = "submit"
